			...
			<div class="wrap-in subWrap">
				<main id="contents">
					...
					<div class="conHeader">
						...
						<h3 class="title">${addr } - ${dto.cname }</h3>
					</div>
					<!-- 사진이랑 설명란 -->
						...
						<div class="detailWrap-in">
							...
							<div class="detailInfo">
								...
								<dl>
									...
									<dd>
										<span>${dto.cpnum1 }-${dto.cpnum2 }-${dto.cpnum3 }</span>
									</dd>
								</dl>
								<dl>
									<dt>
									...
									<dd>
										<span>${dto.copen } ~ ${dto.cclose }</span>
									</dd>
								</dl>
								<dl>
									<dt>
							...
							<div class="review">
								<div class="review-div">
									...
									<form id="insertReview" method="POST">
										<input type="hidden" name="cftName" value="${dto.cname }">
...
var allSum = json.length;
         ...
         if(userid == ''){
            ...
            .then(text => {
               if(text == 1){
                  alert('댓글이 등록되었습니다');
                  content.value = '';
                  location.href = '${cpath}/cafeInfo/${dto.cname}/';
               }
            })
         }
      }
   ...
   // 주소로 좌표를 검색합니다
   geocoder.addressSearch('${dto.caddr}', function(result, status) {
       ...
       // 정상적으로 검색이 완료됐으면 
        if (status === kakao.maps.services.Status.OK) {
           ...
           var infowindow = new kakao.maps.InfoWindow({
               content: '<div style="width:150px;text-align:center;padding:6px 0;border-radius:50%;text-weight: bold;">'+'${dto.cname}'+'</div>'
           });
           ...
           var back = '${cpath}/cafeInfo/${dto.cname}/';
           alert('주소 확인 바람 !!');
           location.href = back;
        }
   });   
